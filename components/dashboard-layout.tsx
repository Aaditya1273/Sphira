...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "My SIPs", href: "/sips", icon: TrendingUp, current: false },
    { name: "Yield Optimizer", href: "/yield", icon: Zap, current: false },
    { name: "Emergency Vault", href: "/vault", icon: Lock, current: false },
    { name: "Portfolio", href: "/portfolio", icon: Wallet, current: false },
    { name: "Security", href: "/security", icon: Shield, current: false },
    { name: "Chat Support", href: "/chat", icon: MessageSquare, current: false },
